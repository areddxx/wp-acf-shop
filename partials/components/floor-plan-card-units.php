<?php
/**
 * Floor Plans Card Units
 * Contains unit avialability form the floor plan layout.
 */
...
<div class="floor-plan-card is-active"
	data-categories='<?php echo json_encode($categories); ?>'
	data-price="<?php echo $price_min; ?>"
	data-size="<?php echo $size_min; ?>"
	data-date="<?php echo $available_min; ?>"
>
